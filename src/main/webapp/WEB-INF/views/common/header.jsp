    ...
    <div class="side-menu" id="mySidenav">
         ...
         <div class="loginWrap">
             ...
             <div class="login-area">
                 ...
                 <form action="${contextPath}/member/login" method = "POST" name="loginForm" onsubmit = "return loginInvalidate()">
                     <label>Email Address</label>
                     <input type="text" id ="loginID" name ="loginID">
                     <label>Password</label>
                     <input type="password" id = "loginPw" name = "loginPw">
                     <button id="loginBtn" type="submit"><i class="fa-solid fa-envelope"></i>이메일로 로그인하기</button>
                 </form>
